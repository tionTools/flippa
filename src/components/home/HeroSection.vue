...
<template>
  <section class="flex flex-col gap-10 py-20">
    ...
    <div class="flex items-center gap-3">
      ...
      <RouterLink
        v-if="isSignedIn"
        :to="heroContent.cta.secondary.to"
      ...
      <SignInButton v-else>
        <button class="flex items-center gap-2 px-6 py-2.5 text-sm font-medium border border-gray-300 text-gray-700 rounded-lg">
          <LogIn :size="15" />
          Get Started
        </button>
      </SignInButton>
